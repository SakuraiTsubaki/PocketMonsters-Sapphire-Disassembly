# Pokémon sprite extraction — batch 001

Batch 001 intentionally contains a single species so sprite assets enter the repository in small, reviewable commits.
